...
export default function SermonsPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
              ...
              <div className="fresco-card p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h1 className="font-serif text-2xl font-bold text-foreground">Sermon Library</h1>
                      <p className="text-muted-foreground">Messages from our pastoral team</p>
                    </div>
                  </div>
                  <Button onClick={() => setShowCreateSermon(true)} className="bg-primary hover:bg-primary/90">
      ...
      <CreateSermonDialog open={showCreateSermon} onOpenChange={setShowCreateSermon} />
    </div>
  )
}
