...
export const mockPosts: Post[] = [
  ...
  },
  {
    ...
    mediaThumbnail: "/beautiful-sunrise-over-mountains-with-golden-light.jpg",
  },
  {
    id: "5",
...
class PostService {
  ...
  createPost(
    postData: Omit<Post, "id" | "createdAt" | "updatedAt" | "amenCount" | "commentCount" | "amenedBy" | "bookmarkedBy">,
  ): Post {
    const newPost: Post = {
      ...postData,
  ...
  addComment(commentData: Omit<Comment, "id" | "createdAt" | "amenCount" | "amenedBy">): Comment {
